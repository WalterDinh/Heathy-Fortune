...
export default class Inputs extends React.Component {
    ...
    onClear() {
        let { onClear = () => {}, onChangeText } = this.props;
    ...
    render() {
        ...
        return (
            <Item
                rounded
                style={[styles.containerStyles, onFocus ? GlobalStyles.shadowStyle : {}, containerStyles]}
                onPress={() => this.input._root.focus()}
            >
                <View
                    style={[styles.overlay, !onFocus && transparent ? GlobalStyles.transparent : null, styleOverlay]}
                />
                {!multiline && (
                    <View style={styles.leftIcon}>
                        {leftIcon ? (
                            <IconImage source={onFocus ? lSource : lBlurSource} style={[lStyle]} />
                        ) : leftIconName ? (
                            <Icon
                                name={leftIconName}
...
const styles = {
    ...
    rightWrap: {
        ...
        borderBottomRightRadius: DIMENSION.INPUT_RADIUS,
        borderTopRightRadius: DIMENSION.INPUT_RADIUS
    },
    overlay: {
        position: "absolute",
        width: "100%",
