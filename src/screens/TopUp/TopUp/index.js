...
class TopUp extends React.Component {
    ...
    async componentDidMount() {
        ...
        RNIap.initConnection()
            .then(connected => {
                console.log("itemSkus 11111111", connected, itemSkus);
                if (connected) {
    ...
    render() {
        const { navigation } = this.props;
        const { openModal, selectedItem, loading } = this.state;
        return (
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <View style={{ marginVertical: PD.PADDING_4 }}>
                        <TouchableOpacity onPress={() => alert("comingsoon")}>
