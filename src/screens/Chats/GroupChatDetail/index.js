...
import { FlatList, View, TextInput, Alert, Keyboard } from "react-native";
...
import { CHAT_TYPE, DEVICE, PD, DIMENSION } from "helper/Consts";
                        ...
                        <View style={styles.memberWrap}>
                            ...
                            <TouchableOpacity onPress={() => this.addMember()}>
                                <View style={styles.addMemberWrap}>
                                    ...
                                    {/* <Icon name="person-add" style={styles.addMemIcon} /> */}
                                </View>
                            </TouchableOpacity>
                        </View>
